...
public class ArticleStockReservedEvent implements ExportedEvent<String, JsonNode> {

    private static ObjectMapper mapper = new ObjectMapper();

    private static final String TYPE = "ArticleStock";
    private static final String EVENT_TYPE = "ArticleStockReserved";
    ...
    public ArticleStockReservedEvent(Instant created, ShopOrder shopOrder) {
